...
class RecordingSession:
    ...
    def start_ffmpeg(self):
        ...
        if self.source == "zoom":
            # Dual input: remote participants (BlackHole) + local mic (your voice)
            ...
            logger.info(f"[{self.source}] dual capture: {BLACKHOLE_DEVICE} + {mic}")
        else:
        ...
        # Start monitor so you hear call audio through headphones while recording
        self._start_monitor()
